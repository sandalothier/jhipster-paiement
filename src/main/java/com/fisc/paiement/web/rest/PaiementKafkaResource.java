...
@RestController
@RequestMapping("/api/paiement-kafka")
public class PaiementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PaiementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PaiementKafkaResource(KafkaProperties kafkaProperties) {

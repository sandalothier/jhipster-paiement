package com.fisc.paiement.config.timezone;

import com.fisc.paiement.PaiementApp;
import com.fisc.paiement.repository.timezone.DateTimeWrapper;
import com.fisc.paiement.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = PaiementApp.class)
